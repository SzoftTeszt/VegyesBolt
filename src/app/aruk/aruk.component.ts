...
ngOnChanges(changes:SimpleChanges)
{
  ...
  if ( kategoriaValtozas 
    && kategoriaValtozas.previousValue!=kategoriaValtozas.currentValue)
    this.get();
}


constructor(private base:BaseService, private config:ConfigService,
  private rendeles:RendelesService)
{ 
  this.get();
...
addTetel(aru:any, mennyiseg:any){
  ...
  this.rendeles.addTetel({aru:aru, mennyiseg:mennyiseg})
